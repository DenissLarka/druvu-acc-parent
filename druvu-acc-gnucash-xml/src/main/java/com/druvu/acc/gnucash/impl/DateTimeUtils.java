...
public final class DateTimeUtils {
    ...
    /**
     * Formats a date as a GnuCash timestamp string (ts:date element), at start of day in UTC. The result round-trips
     * through {@link #parseTimestamp(String)}.
     *
    ...
    /**
     * Formats a date-time as a GnuCash timestamp string (ts:date element), in UTC. The result round-trips through
     * {@link #parseTimestamp(String)}.
     *
